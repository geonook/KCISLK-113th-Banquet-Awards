      ...
      {showContent && (
        <div className="relative z-10 text-center px-6 w-[85%] max-w-[4800px] mx-auto animate-slide-up">
          <div className="relative animate-scale-in" style={{ animationDelay: "0.8s" }}>
            ...
            {/* 主卡片 */}
            <div className="relative bg-white/25 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-purple-200/30 overflow-hidden">
              {/* 裝飾性幾何元素 - 彩虹頂部條 */}
              ...
              <div className="space-y-6 animate-slide-up" style={{ animationDelay: "2s" }}>
                <div className="flex flex-wrap justify-center items-center gap-6 text-lg md:text-xl">
                  <div
                    className="px-8 py-4 bg-gradient-to-r from-purple-50 to-pink-100 rounded-full border border-purple-200 shadow-lg animate-slide-right hover:scale-105 transition-transform"
                    style={{ animationDelay: "2.2s" }}
                  >
                    <p className="font-semibold text-gray-700 whitespace-nowrap">
                      🏆 卓越表現 Excellence Performance
                    </p>
                  </div>

                  <div
                    className="w-4 h-4 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-full animate-pulse"
                    style={{ animationDelay: "2.4s" }}
                  />

                  <div
                    className="px-8 py-4 bg-gradient-to-r from-blue-50 to-green-100 rounded-full border border-blue-200 shadow-lg animate-slide-left hover:scale-105 transition-transform"
                    style={{ animationDelay: "2.6s" }}
                  >
                    <p className="font-semibold text-gray-700 whitespace-nowrap">
                      🌟 專業典範 Professional Excellence
                    </p>
                  </div>
                </div>
                ...
                {/* 榮譽說明 */}
                <div
                  className="mt-10 p-8 bg-gradient-to-r from-white/80 to-purple-50/80 rounded-2xl border border-purple-200 shadow-inner animate-slide-up"
                  style={{ animationDelay: "2.8s" }}
                >
                  <p className="text-xl font-medium text-gray-800 mb-3" style={{textShadow: "1px 1px 2px rgba(255,255,255,0.8)"}}>
                    🎖️ 表彰優秀同仁卓越貢獻 / Recognizing Outstanding Staff Excellence
                  </p>
                  <p className="text-lg text-gray-700" style={{textShadow: "1px 1px 2px rgba(255,255,255,0.8)"}}>
                    感謝您的傑出表現與專業精神 / Thank you for your outstanding performance and professionalism
                  </p>
                </div>
              </div>
            </div>
