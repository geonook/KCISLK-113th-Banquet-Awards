              ...
              <div className="grid md:grid-cols-5 gap-10 items-center">
                ...
                >
                  <div className="relative group">
                    ...
                    {/* 照片框架 - 更大尺寸 +25% */}
                    <div className="w-[35rem] h-[35rem] rounded-full overflow-hidden shadow-2xl relative z-10 border-6 border-orange-300 group-hover:scale-105 transition-transform duration-300">
                      {winner.photoUrl ? (
                        <Image
                ...
                <div className="md:col-span-3 text-center md:text-left space-y-6">
                  ...
                  {/* 優質獎類型 - 智能字體大小+立體效果 */}
                  <h2
                    className={`${getAwardTypeFontSize(winner.awardType)} font-black mb-4 animate-slide-left text-orange-400`}
                    style={{
