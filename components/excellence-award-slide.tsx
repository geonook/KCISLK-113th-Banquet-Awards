          ...
          <div className="relative animate-scale-in" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 overflow-hidden p-8">
              ...
              <div className="grid md:grid-cols-5 gap-8 items-center">
                ...
                >
                  <div className="relative group">
                    ...
                    {/* 照片框架 - 更大尺寸 */}
                    <div className="w-56 h-56 rounded-full overflow-hidden shadow-2xl relative z-10 border-6 border-orange-300 group-hover:scale-105 transition-transform duration-300">
                      {winner.photoUrl ? (
                        <Image
                ...
                <div className="md:col-span-3 text-center md:text-left space-y-6">
                  ...
                  >
                    <div
                      className="inline-flex items-center px-8 py-4 rounded-full font-bold text-white shadow-xl border-2 border-white/20 text-xl bg-gradient-to-r from-orange-500 via-red-500 to-pink-500"
                  ...
                  {/* 優質獎類型 - 更大字體 */}
                  <h2
                    className="text-5xl md:text-6xl font-black mb-4 animate-slide-left text-orange-600"
                    style={{
              ...
              <div className="mt-8 animate-slide-up" style={{ animationDelay: "0.8s" }}>
                <div className="bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 rounded-2xl p-8 border-l-6 border-orange-500 shadow-inner relative overflow-hidden">
                  {/* 背景裝飾 */}
