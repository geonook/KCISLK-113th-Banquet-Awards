...
interface Service10YearTitleSlideProps {
  isActive?: boolean
}

export function Service10YearTitleSlide({ isActive = true }: Service10YearTitleSlideProps) {
    ...
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 animate-scale-in">
        <Image
          ...
          alt="10 Year Service Award background"
          fill
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 30% 20%, rgba(205, 127, 50, 0.3) 0%, transparent 50%),
            radial-gradient(circle at 70% 80%, rgba(255, 165, 0, 0.3) 0%, transparent 50%),
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(40)].map((_, i) => (
          ...
          >
            <div
              className={`w-3 h-3 rounded-full shadow-lg animate-sparkle bg-gradient-to-r from-orange-300 via-amber-400 to-orange-500`}
      ...
      <div className="absolute top-12 left-12 z-20 animate-slide-right" style={{ animationDelay: "0.8s" }}>
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-amber-500 to-orange-600 rounded-2xl blur-xl opacity-60" />
      ...
      {showContent && (
        <div className="relative z-10 text-center px-6 w-[85%] max-w-[4800px] mx-auto animate-slide-up">
          <div className="relative animate-scale-in" style={{ animationDelay: "0.8s" }}>
            {/* 背景光暈效果 */}
            <div className="absolute inset-0 bg-gradient-to-r from-orange-300/20 via-amber-400/20 to-orange-500/20 rounded-3xl blur-3xl scale-110" />
            ...
            <div className="relative bg-white/25 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-orange-200/30 overflow-hidden">
              ...
              {/* 動態裝飾圓圈 */}
              <div className="absolute -top-8 -left-8 w-16 h-16 bg-gradient-to-br from-orange-400 via-amber-500 to-orange-600 rounded-full opacity-30 animate-spin-slow" />
              <div className="absolute -bottom-8 -right-8 w-20 h-20 bg-gradient-to-br from-amber-400 via-orange-500 to-orange-600 rounded-full opacity-30 animate-spin-reverse" />
              ...
              <div className="mb-10 animate-slide-up" style={{ animationDelay: "1.2s" }}>
                ...
                >
                  熱忱投入，銅質風華 / Passionate Dedication, Bronze Excellence
                </p>
              </div>

              {/* 裝飾線條 */}
              <div className="relative mb-10 animate-slide-up" style={{ animationDelay: "1.8s" }}>
                <div className="h-1 bg-gradient-to-r from-orange-400 via-amber-500 to-orange-600 mx-auto animate-expand" />
              ...
              <div className="space-y-6 animate-slide-up" style={{ animationDelay: "2s" }}>
                <div className="flex flex-wrap justify-center items-center gap-6 text-lg md:text-xl">
                  <div
                    className="px-8 py-4 bg-gradient-to-r from-orange-50 to-amber-100 rounded-full border border-orange-200 shadow-lg animate-slide-right hover:scale-105 transition-transform"
                    style={{ animationDelay: "2.2s" }}
                  >
                    <p className="font-semibold text-gray-700 whitespace-nowrap">
                      🥉 10年服務 10 Years Service
                    </p>
                  </div>

                  <div
                    className="w-4 h-4 bg-gradient-to-r from-orange-400 via-amber-500 to-orange-600 rounded-full animate-pulse"
                    style={{ animationDelay: "2.4s" }}
                  />

                  <div
                    className="px-8 py-4 bg-gradient-to-r from-amber-50 to-orange-100 rounded-full border border-amber-200 shadow-lg animate-slide-left hover:scale-105 transition-transform"
                    style={{ animationDelay: "2.6s" }}
                  >
                    <p className="font-semibold text-gray-700 whitespace-nowrap">
                      🔥 熱忱投入 Passionate Dedication
                    </p>
                  </div>
                </div>
                ...
                >
                  <p className="text-xl font-medium text-gray-800 mb-3" style={{textShadow: "1px 1px 2px rgba(255,255,255,0.8)"}}>
                    🏆 表彰10年熱忱服務 / Honoring 10 Years of Passionate Service
                  </p>
                  <p className="text-lg text-gray-700" style={{textShadow: "1px 1px 2px rgba(255,255,255,0.8)"}}>
                    感謝您的熱忱投入與持續成長 / Thank you for your passionate dedication and continuous growth
                  </p>
                </div>
              </div>
            </div>
