...
export function SmoothNavigation({ currentSlide, totalSlides, onPrevious, onNext }: SmoothNavigationProps) {
  return (
    <>
      {/* 優化計數器動畫 */}
      <motion.div
      ...
      >
        <Button
          onClick={onPrevious}
          className="bg-white/90 hover:bg-white text-gray-800 shadow-xl backdrop-blur-sm px-6 py-3 rounded-full font-semibold transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100 border border-white/30"
