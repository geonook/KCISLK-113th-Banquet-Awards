          ...
          <div className="relative animate-scale-in" style={{ animationDelay: "0.8s" }}>
            ...
            <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-14 shadow-2xl border border-white/30 overflow-hidden">
              ...
              <div className="mb-10 animate-slide-up" style={{ animationDelay: "1s" }}>
                {/* 主標題 */}
                <h1
                  className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-8 leading-none"
                  style={{
                    background:
                ...
                <p
                  className="text-xl md:text-2xl lg:text-3xl text-gray-700 font-semibold tracking-wide animate-slide-up mb-6"
